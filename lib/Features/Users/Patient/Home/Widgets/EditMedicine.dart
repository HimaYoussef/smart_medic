    ...
    try {
      Map<String, dynamic> updates = {
        ...
        'scheduleValue': _scheduleType == 1
            ? (_numTimesController.text.isNotEmpty ? int.parse(_numTimesController.text) : 0)
            : _scheduleType == 2
            ? (_daysIntervalController.text.isNotEmpty ? int.parse(_daysIntervalController.text) : 0)
            : 0,
        'times': _times,
