...
import 'package:smart_medic/core/widgets/changePassPage.dart';
                ...
                children: [
                  Showcase(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                          S.of(context).Admin_Profile_Supervisor_Data_Display),
                  ...
                  Showcase(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                          S.of(context).Admin_Profile_Patient_Data_Display),
                      trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                      onTap: () {
                        Navigator.push(
                          context,
                  ...
                  Showcase(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                          S.of(context).Patient_Profile_view_Change_Language),
                      trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                      onTap: () {
                  ...
                  ListTile(
                    ...
                    title: Text(S.of(context).Admin_Profile_Change_Password),
                    trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                    onTap: () {
                      Navigator.push(
                        context,
