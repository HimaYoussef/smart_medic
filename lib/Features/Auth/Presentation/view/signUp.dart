          ...
          listener: (context, state) {
            if (state is SignUpLoading) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("Account created successfully!",style: TextStyle(color: AppColors.white))),
              );
              if (role == 'Patient') {
                                ...
                                if (_isLoading)
                                  ...
                                  CustomButton(text: "SIGN Up", onPressed: () async {
                                    ...
                                    if(email==''&& password==''&&confirmPassword=='') {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('Please enter a vaild email',style: TextStyle(color: AppColors.white))),
                                      );
                                    }
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                            content:
                                            Text("Passwords do not match",style: TextStyle(color: AppColors.white))),
                                      );
                                    }
                                    else{
                                     await BlocProvider.of<SignUpCubit>(context).signUp(name: name, email: email, password: password, type: role);
                                    }
                                  })
                              ],
                            ),
